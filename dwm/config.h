...
static const char *rofipowercmd[] = { "rofi", "-show", "p", "-modi", "p:rofi-power-menu", NULL };

static const char *monitorcmd[] = { "switchmonitor", NULL };

static const char *brupcmd[] = { "sudo", "xbacklight", "-inc", "10", NULL };
static const char *brdowncmd[] = { "sudo", "xbacklight", "-dec", "10", NULL };

static const char *termcmd[]  = { "alacritty", NULL }; static const Key keys[] = {

	/* modifier                     key        function        argument */
	/*{ MODKEY,                       XK_d,      spawn,          {.v = dmenucmd } },*/
	{ MODKEY,                       XK_d,      spawn,          {.v = roficmd } },
	{ MODKEY|ShiftMask,             XK_x,      spawn,          {.v = rofipowercmd } },
	{ MODKEY,             		XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_u,      spawn,          {.v = lockscreencmd } },
